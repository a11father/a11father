...
.AUTHOR
James Volley
L3 Enterprise Desktop Support Spec.
James.M.Volley.-ND@disney.com

.DESCRIPTION
Original PowerShell script generated by Microsoft "CreateExoPSSession.ps1"
Added AzureAD install
Added MSOnline install
Search for UPN for authentication
Script now connects Exchange Online + Office365

#>
$MSOIDSVC = "C:\Program Files\Common Files\microsoft shared\Microsoft Online Services\MSOIDSVC.EXE"
$MSOIDSVCPath = Test-Path $MSOIDSVC
If ($MSOIDSVCPath -eq $false){
Add-Type -AssemblyName PresentationCore,PresentationFramework
$ButtonType = [System.Windows.MessageBoxButton]::YesNoCancel
$MessageIcon = [System.Windows.MessageBoxImage]::Question
$MessageBody = "Microsoft Online Services is not installed. Select Yes to install."
$MessageTitle = "Connect to Office365 and Exchange Online"
$Result = [System.Windows.MessageBox]::Show($MessageBody,$MessageTitle,$ButtonType,$MessageIcon)
Write-Host "Your choice is $Result"
Clear-Host}
If ($Result -eq "Yes") {
& msiexec.exe /i "\\wdw\data\CorpSEClientServices\Data\Level 3\scripts\ConnectToOffice365\msoidcli_64 .msi" /passive /norestart
Write-Host -ForegroundColor Yellow "Installing Microsoft Online Services"
Write-Host -ForegroundColor Yellow "Please wait..."
Start-sleep -Seconds 90
Set-Service -Name msoidsvc -StartupType Manual
Clear-Host}
$AzureADinstalled = Get-InstalledModule | Where-Object{ $_.Name -eq "AzureAD"}
$MSOnlineinstalled = Get-InstalledModule | Where-Object{ $_.Name -eq "MSOnline"}
If (-not($AzureADinstalled.Name -eq "AzureAD")) {Install-Module -Name AzureAD -Force}
If (-not($MSOnlineinstalled.Name -eq "MSOnline")) {Install-Module -Name MSOnline -Force}
Import-Module -Name AzureAD; Import-Module -Name MSOnline
...
$creds = Get-Credential -Message "Please enter your Domain password" -UserName $UPN
Connect-MSolService -Credential $creds

$UserPath = "\\wdw\data\CorpSEClientServices\Data\Level 3\scripts\ConnectToOffice365\exo_files"
cd $UserPath
...
function Connect-EXOPSSession 
{
    ...
    process {
        ...
        try
        {
            ...
            $ExoPowershellModule = "\\wdw\data\CorpSEClientServices\Data\Level 3\scripts\ConnectToOffice365\exo_files\Microsoft.Exchange.Management.ExoPowershellModule.dll";
...
Clear-Host
cd C:\
$LogPath = "\\wdw\data\CorpSEClientServices\Data\Level 3\scripts\ConnectToOffice365\log\ConnectToOffice365.log"
$LogDate = Get-Date -Format 'MM/dd/yyyy hh:mm'
$LogPC = (Get-WmiObject -Class Win32_ComputerSystem -Property Name).Name
$LogRunBy = $env:USERDOMAIN + "\" + $env:USERNAME
$LogSpace= "====================`n"
$Log = Write-Output "Date: $LogDate","Computer: $LogPC","RunBy: $LogRunBy","$LogSpace" | Out-File -FilePath $LogPath -Append
